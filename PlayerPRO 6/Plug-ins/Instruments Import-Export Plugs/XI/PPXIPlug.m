...
- (BOOL)importInstrumentAtURL:(NSURL*)sampleURL instrument:(out PPInstrumentObject**)outHeader driver:(PPDriver*)driver error:(NSError * _Nullable __autoreleasing * _Nonnull)error
{
	XMPATCHHEADER	*pth;
	XMWAVHEADER		*wh = NULL;
	short			numSamples;
